...
void CaptureWidget::paintEvent(QPaintEvent* paintEvent)
{
    ...
    GeneralConf::xywh_position position =
        static_cast<GeneralConf::xywh_position>(m_config.
    ...
    */
    ...
    if (m_selection && m_xywhDisplay) {
        ...
        painter.fillRect(
            ...
            xybox.height(),
            QBrush(uicolor));
        painter.setPen(ColorUtils::colorIsDark(uicolor)
                           ? Qt::white
                           : Qt::black);
        painter.drawText(x0,
                         y0,
...
void CaptureWidget::initSelection()
{
    ...
    connect(m_selection,
            &SelectionWidget::visibilityChanged,
            this,
            [this]() {
...
void CaptureWidget::initShortcuts()
{
    ...
    newShortcut(
        QKeySequence(ConfigHandler().shortcut("TYPE_REDO")),
        this,
        SLOT(redo()));
